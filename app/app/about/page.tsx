...
export default memo(function AboutPage(): ReactNode {
  return (
    <div className="flex w-screen px-4">
      <Card className="prose mx-auto mb-8 mt-4 flex w-[56rem] max-w-full flex-col">
        ...
        <h4>How to play</h4>
        <p>
          At the start of the game, each player chooses two secret words.
          Players gain points by successfully guessing parts of their
          ...
          When there is at most one player remaining, the player with the
          highest score wins.
        </p>
        <p>
        ...
        <p>
          ...
          style of Wordle. Letters in the guess which are in the correct
          position in the secret word are marked green, while letters in the
          guess which are in the secret word but at a different position are
          marked yellow. Players are awarded points based on how good their
          guesses were, and play proceeds to the next round.
        </p>
        <p>
        ...
        <p>
          Further, a guess that correctly guesses a full word earns an
        ...
        <p>
          ...
          <a href="/secret-wordlist.txt">allowed secrets</a>,{" "}
        ...
        <p>
          Worth of Words is fully decentralized and trustless. All in-game
          actions and all communication between players occur via the
          blockchain.
        </p>
        ...
        <p>
          Worth of Words&apos;s accounts use a <b>session key plugin</b> to
          create frontend session keys, so users can securely take many on-chain
          actions throughout a game without clicking through a security prompt
          each time.
        </p>
        <h4>Gas Manager</h4>
        <p>
          Although gameplay takes place fully on-chain, players are never
          required to spend their own money to pay for transactions. This is
          possible through Alchemy&apos;s{" "}
          <a href={ABOUT_GAS_MANAGER_URL}>Gas Manager</a>, a smart contract that
          allows Worth of Words to sponsor users so they play without using
          their own money to put actions on the blockchain.
        </p>
        <h4>Account Kit</h4>
        <p>
          Modular Accounts and the Gas Manager are both part of{" "}
          <a href={ABOUT_ACCOUNT_KIT_URL}>Account Kit</a>, Alchemy&apos;s
          framework for building applications with embedded accounts. In
          addition to the above, Worth of Words also uses Account Kit&apos;s{" "}
        ...
        <p>
          ...
          allow players to prove that they are playing correctly without
        ...
        <ul>
          <li>
            ...
            must prove that the words they have chosen are real English words,
